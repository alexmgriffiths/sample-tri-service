...
const file_echo_v1_echo_proto_rawDesc = "" +
	...
	"\vEchoService\x123\n" +
	"\x04Echo\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponseB\x9e\x01\n" +
	"\vcom.echo.v1B\tEchoProtoP\x01ZEgithub.com/alexmgriffiths/example-service/go/pkg/proto/echo/v1;echov1\xa2\x02\x03EXX\xaa\x02\aEcho.V1\xca\x02\bEcho_\\V1\xe2\x02\x14Echo_\\V1\\GPBMetadata\xea\x02\bEcho::V1b\x06proto3"
