...
const file_greeter_v1_greeter_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x18.greeter.v1.HelloRequest\x1a\x16.greeter.v1.HelloReplyB\xb4\x01\n" +
	"\x0ecom.greeter.v1B\fGreeterProtoP\x01ZKgithub.com/alexmgriffiths/example-service/go/pkg/proto/greeter/v1;greeterv1\xa2\x02\x03GXX\xaa\x02\n" +
	"Greeter.V1\xca\x02\n" +
