        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_server_time(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/time.v1.TimeService/GetServerTime",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("time.v1.TimeService", "GetServerTime"));
...
pub mod time_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/time.v1.TimeService/GetServerTime" => {
                    ...
                    struct GetServerTimeSvc<T: TimeService>(pub Arc<T>);
                    impl<T: TimeService> tonic::server::UnaryService<super::TimeRequest>
                    for GetServerTimeSvc<T> {
                        type Response = super::TimeResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TimeService>::get_server_time(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: TimeService> tonic::server::NamedService for TimeServiceServer<T> {
        const NAME: &'static str = "time.v1.TimeService";
    }
}
